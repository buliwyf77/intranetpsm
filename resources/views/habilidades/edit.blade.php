...
@section('title')
  <a href="{{route('areas.index')}}" class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Habilidades Registradas">
...
<div class="content">
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
          ...
          {{Form::model($habilidade, ['route' => ['habilidades.update', $habilidade->id], 'method' => 'patch'])}}
