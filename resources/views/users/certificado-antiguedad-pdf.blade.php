...
<table>
    ...
    <tr>
        ...
        <td align="left"><img src="http://psmservicios.cl/intranet/images/psm-small.png" alt="logo-psm" ></td>
...
<div align="right" class="p1">
    ...
    @php $fecha = \Carbon\Carbon::parse(date('Y')) @endphp

    <p> Santiago, {{ucfirst($fecha->monthName)}} de {{date('Y')}} </p>
...
<div class="firmas ">
    ...
    <div class="lado-izquierdo">
        ...
        <img src="{{$firma1}}" alt="firma1"  width="200px" height="140px" style="z-index:2;>
